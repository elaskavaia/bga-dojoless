...
class dojoless extends Table
{
    ...
    */
     ...
     * (note: each method below must match an input method in dojoless.action.php)
     */
    function action_playCard($card_id) {
        ...
        self::notifyAllPlayers("message", clienttranslate('${player_name} plays ${card_name}'), array (
                'player_id' => $player_id,'player_name' => self::getActivePlayerName(),'card_name' => $card_id,
                'card_id' => $card_id ));
        $this->gamestate->nextState('next');
    }
    function action_playVote() {
        self::checkAction('playVote');
        $player_id = self::getActivePlayerId();
        self::notifyAllPlayers("message", clienttranslate('${player_name} wants to vote'), [
    ...
    function action_playSupport() {
        self::checkAction('playSupport');
        $player_id = $this->getCurrentPlayerId();
        self::notifyAllPlayers("message", clienttranslate('${player_name} supports'), [
                'player_id' => $player_id,'player_name' => self::getActivePlayerName()
    ...
    function action_playOppose() {
        ...
        $player_id = $this->getCurrentPlayerId();
        self::notifyAllPlayers("message", clienttranslate('${player_name} opposes'), [
                'player_id' => $player_id,'player_name' => self::getActivePlayerName()
...
////////////
    ...
    */
    ...
    function arg_playerTurnB(){
        return ['otherplayer'=> $this->getActivePlayerName(),
                'otherplayer_id'=> $this->getActivePlayerId()
        ];
    }
    
    function arg_playerTurnA(){
        return [];
    }
